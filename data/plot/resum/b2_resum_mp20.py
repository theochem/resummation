...
# 调整两个y轴的显示范围
ax1.set_ylim(-10, 10)  # outliers only
ax2.set_ylim(-120, -100)  # most of the data
ax3.set_ylim(-2400, -2200)  # most of the data
...
fig.text(-0.02, 0.5, 'Energy Correlation [mhartree]', va='center', rotation='vertical',fontsize=16)
