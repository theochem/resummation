...
# 调整两个y轴的显示范围
axes[0].set_ylim(-50, 20)  # outliers only
axes[1].set_ylim(-23000, -22000)  # most of the data
...
fig.text(-0.05, 0.5, 'Energy Correlation [mhartree]', va='center', rotation='vertical',fontsize=16)
