...
w = 0.75
dimw = w / dim
method = ['MPn',r'Pad$\'e[0,1]$',r'Borel-Pad$\'e[0,1]$']
...
# 调整两个y轴的显示范围
axes[0].set_ylim(-70, 40)  # outliers only
axes[1].set_ylim(-270, -250)  # most of the data
...
fig.text(0, 0.5, 'Energy Correlation [hartree]', va='center', rotation='vertical',fontsize=16)
