...
for i in range(len(data[0])):
    ...
    if i==2:
        ...
        axes[2].bar(x + i * dimw, y, dimw, bottom=0, yerr=err[:,0],label=method[i])
    else:
...
# 调整两个y轴的显示范围
axes[0].set_ylim(300, 320)  # outliers only
axes[1].set_ylim(-10, 60)  # outliers only
axes[2].set_ylim(-24000, -23500)  # most of the data
